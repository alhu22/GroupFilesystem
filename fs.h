...
private:
    ...
    int8_t parent_index[64];
    int8_t current_index;
    uint16_t N_DIRECTORIES = (BLOCK_SIZE/sizeof(dir_entry));  // 64
...
public:
    ...
    int find_file(std::string filepath, dir_entry *entry);

    int create_folder(std::string dirpath);
